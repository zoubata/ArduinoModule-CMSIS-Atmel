...
#define EVSYS_CHSTATUS_MASK         _U(0x003F003F) /**< \brief (EVSYS_CHSTATUS) MASK Register */
...
#define EVSYS_INTENCLR_MASK         _U(0x003F003F) /**< \brief (EVSYS_INTENCLR) MASK Register */
...
#define EVSYS_INTENSET_MASK         _U(0x003F003F) /**< \brief (EVSYS_INTENSET) MASK Register */
...
#define EVSYS_INTFLAG_MASK          _U(0x003F003F) /**< \brief (EVSYS_INTFLAG) MASK Register */
...
#define EVSYS_SWEVT_CHANNEL_Msk     (_U(0x3F) << EVSYS_SWEVT_CHANNEL_Pos)
#define EVSYS_SWEVT_CHANNEL(value)  (EVSYS_SWEVT_CHANNEL_Msk & ((value) << EVSYS_SWEVT_CHANNEL_Pos))
#define EVSYS_SWEVT_MASK            _U(0x0000003F) /**< \brief (EVSYS_SWEVT) MASK Register */
...
#define EVSYS_USER_MASK             _U(0x0000000F) /**< \brief (EVSYS_USER) MASK Register */
