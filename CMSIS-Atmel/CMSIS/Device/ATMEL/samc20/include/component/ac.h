...
#define AC_EVCTRL_MASK              _U(0xFF1F)   /**< \brief (AC_EVCTRL) MASK Register */
...
#define AC_INTENCLR_MASK            _U(0x1F)     /**< \brief (AC_INTENCLR) MASK Register */
...
#define AC_INTENSET_MASK            _U(0x1F)     /**< \brief (AC_INTENSET) MASK Register */
...
#define AC_INTFLAG_MASK             _U(0x1F)     /**< \brief (AC_INTFLAG) MASK Register */
...
#define AC_STATUSA_MASK             _U(0x3F)     /**< \brief (AC_STATUSA) MASK Register */
