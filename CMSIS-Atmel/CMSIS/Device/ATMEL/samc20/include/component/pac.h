...
#define PAC_INTFLAGAHB_MASK         _U(0x000000FF) /**< \brief (PAC_INTFLAGAHB) MASK Register */
...
#define PAC_INTFLAGC_MASK           _U(0x01D3FE1F) /**< \brief (PAC_INTFLAGC) MASK Register */
...
#define PAC_STATUSC_MASK            _U(0x01D3FE1F) /**< \brief (PAC_STATUSC) MASK Register */
