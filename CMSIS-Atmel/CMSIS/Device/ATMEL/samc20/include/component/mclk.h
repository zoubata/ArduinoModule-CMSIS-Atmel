...
#define MCLK_AHBMASK_RESETVALUE     _U(0x00001CFF) /**< \brief (MCLK_AHBMASK reset_value) AHB Mask */
...
#define MCLK_AHBMASK_MASK           _U(0x00001CFF) /**< \brief (MCLK_AHBMASK) MASK Register */
...
#define MCLK_APBCMASK_MASK          _U(0x01D3FE1F) /**< \brief (MCLK_APBCMASK) MASK Register */
