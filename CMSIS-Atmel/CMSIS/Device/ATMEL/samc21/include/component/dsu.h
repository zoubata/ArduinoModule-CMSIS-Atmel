...
#define DSU_STATUSC_RESETVALUE      _U(0x00)     /**< \brief (DSU_STATUSC reset_value) Status C */

#define DSU_STATUSC_STATE_Pos       0            /**< \brief (DSU_STATUSC) State */
#define DSU_STATUSC_STATE_Msk       (_U(0x7) << DSU_STATUSC_STATE_Pos)
#define DSU_STATUSC_STATE(value)    (DSU_STATUSC_STATE_Msk & ((value) << DSU_STATUSC_STATE_Pos))
#define DSU_STATUSC_MASK            _U(0x07)     /**< \brief (DSU_STATUSC) MASK Register */
...
#define   DSU_DID_SERIES_1_Val            _U(0x1)   /**< \brief (DSU_DID) Cortex-M0+ processor, CAN */
