...
#define REG_TAL_CPUIRQS0           (0x42006064) /**< \brief (TAL) Interrupt Status for CPU 0 */
#else
...
#define REG_TAL_CPUIRQS0           (*(RoReg  *)0x42006064UL) /**< \brief (TAL) Interrupt Status for CPU 0 */
